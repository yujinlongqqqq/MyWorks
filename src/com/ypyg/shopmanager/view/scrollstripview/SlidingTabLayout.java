...
public class SlidingTabLayout extends HorizontalScrollView {
	...
	private InternalViewPagerListener mPagerListener = new InternalViewPagerListener();
	...
	private ArrayMap<Integer, Fragment> mFragmentMap;

	public void setViewPager(ViewPager viewPager, ArrayMap<Integer, Fragment> fragmentMap) {
	...
	private class InternalViewPagerListener implements ViewPager.OnPageChangeListener {
		...
		public void onPageSelected(int position) {
			...
			if (fragment != null && fragment instanceof FragmentOrderListSingle) {
				FragmentOrderListSingle fSingle = (FragmentOrderListSingle) fragment;
				fSingle.toReflash();
			}
			// // 避免面其它页面请求
			// int length = mFragmentMap.size();
			// for (int i = 0; i < length; i++) {
			// Fragment fragment = mFragmentMap.get(i);
			// if (fragment != null && fragment instanceof
			// FragmentOrderListSingle) {
			// if (i == position) {
			// ((FragmentOrderListSingle) fragment).isRequest = true;
			// } else {
			// ((FragmentOrderListSingle) fragment).isRequest = false;
			// }
			//
			// }
			//
