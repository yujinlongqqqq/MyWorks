 ...
 */
public class SplashWheelVerticalView extends AbstractWheelView {
	 ...
	 */
	public SplashWheelVerticalView(Context context) {
		this(context, null);
	}
	 ...
	 */
	public SplashWheelVerticalView(Context context, AttributeSet attrs) {
	...
	public void setSelectorPaintCoeff(float coeff) {
		...
		if (mVisibleItems == 2) {
			...
			int[] colors = {c2, c1, Color.WHITE, Color.WHITE, c1, c2};
			...
			int[] colors = {0, c3, c2, c1, Color.WHITE, Color.WHITE, c1, c2,
					c3, 0};
