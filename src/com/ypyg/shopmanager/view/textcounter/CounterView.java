package com.ypyg.shopmanager.view.textcounter;
...
import com.ypyg.shopmanager.view.textcounter.formatters.CommaSeparatedDecimalFormatter;
import com.ypyg.shopmanager.view.textcounter.formatters.DecimalFormatter;
import com.ypyg.shopmanager.view.textcounter.formatters.IntegerFormatter;
import com.ypyg.shopmanager.view.textcounter.formatters.NoFormatter;

/**
 * Created by prem on 10/28/14.
 * 
 * A TextView that counts values depending on the attributes set via xml or via
 * java. Depending on the value set in {@link #setAutoStart(boolean)}, the
 * counter will start. You may call {@link #start()} to start manually at any
 * time.
 */
public class CounterView extends TextView {
	...
	/**
	 * Set the time interval between each increment. Default is
	...
	/**
	 * Set the increment between the two values. Can be negative or positive.
	 * Default is {@link #DEFAULT_INCREMENT}
	 * 
	 * @param increment
	 */
	...
	/**
	 * Set the counterType. See
	 * {@link com.github.premnirmal.textcounter.CounterType} for further details
	 * 
	 * @param counterType
	 */
	 ...
	 * {@link com.github.premnirmal.textcounter.CounterType} set using
	 * {@link #setCounterType(CounterType)}
	 * 
	 * @param formatText
	 */
	...
	/**
	 * Set a custom {@link com.github.premnirmal.textcounter.Formatter} to
	 * format the text before {@link #setText(CharSequence)} is called
	 * 
	 * @param formatter
	 */
