package com.ypyg.shopmanager.view.pulltorefresh;
 ...
 * 
 */
public class PullToRefreshPinnedHExListView extends PullToRefreshBase<ListView>
	 ...
	 *            context
	 */
	public PullToRefreshPinnedHExListView(Context context) {
		this(context, null);
	}
	 ...
	 *            attrs
	 */
	public PullToRefreshPinnedHExListView(Context context, AttributeSet attrs) {
	...
	protected ListView createRefreshableView(Context context, AttributeSet attrs) {
		...
		PinnedHeaderExpandableListView listView = new PinnedHeaderExpandableListView(
				context);
		mListView = listView;
		listView.setCacheColorHint(Color.parseColor("#00000000"));
		listView.setOnScrollListener(this);
		listView.setChildDivider(getResources().getDrawable(R.drawable.child_bg));
