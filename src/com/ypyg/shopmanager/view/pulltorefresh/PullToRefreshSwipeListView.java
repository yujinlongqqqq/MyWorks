...
public class PullToRefreshSwipeListView extends PullToRefreshBase<ListView>
	...
	protected ListView createRefreshableView(Context context, AttributeSet attrs) {
		...
		ListView listView = (SwipeListView) inflater.inflate(
				R.layout.swipe_listview, null);
		listView.setCacheColorHint(Color.parseColor("#00000000"));
		// ListView listView = new customlistview(context);
		mListView = listView;
		listView.setOnScrollListener(this);
		String text = AppUtil.format(System.currentTimeMillis());
