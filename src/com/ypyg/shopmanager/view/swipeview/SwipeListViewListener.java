...
public interface SwipeListViewListener {
    ...
    /**
     * Called when user clicks on the convert view
     * @param position list item
     */
    void onClickParentView(View v,int position);

    /**
     * Called when user clicks on the front view
     * @param position list item
     */
    void onClickFrontView(View v,int position);
     ...
     */
    void onDismiss(ArrayList<Integer> reverseSortedPositions);
