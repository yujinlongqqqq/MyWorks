...
package com.ypyg.shopmanager.view.swipeview;
...
public class SwipeListView extends ListView {
    ...
    public void dismiss(int position) {
        ...
        if (height > 0) {
            ...
            ArrayList<Integer> dismissPositions = new   ArrayList<Integer>();
//            dismissPositions[0] = position;
            dismissPositions.add(position);
...
//            dismissPositions[i] = position;
     ...
     */
    protected void onDismiss(ArrayList<Integer> reverseSortedPositions) {
    ...
    /**
     * Notifies onClickParentView
     *
     * @param position item clicked
     */
    protected void onClickParentView(View v,int position) {
        if (swipeListViewListener != null && position != ListView.INVALID_POSITION) {
            swipeListViewListener.onClickParentView(v, position);
        }
    }
     ...
     * @param position item clicked
     */
    protected void onClickFrontView(View v,int position) {
        if (swipeListViewListener != null && position != ListView.INVALID_POSITION) {
            swipeListViewListener.onClickFrontView(v,position);
        }
    }
