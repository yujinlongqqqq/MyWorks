...
import com.ypyg.shopmanager.view.pulltorefresh.FooterLoadingLayout;
import com.ypyg.shopmanager.view.pulltorefresh.ILoadingLayout.State;
import com.ypyg.shopmanager.view.pulltorefresh.LoadingLayout;
 ...
 * 
 */
public class PullToRefreshTitledListView extends PullToRefreshBase<ListView> implements OnScrollListener {
	/** ListView */
	 ...
	 *            context
	 */
	public PullToRefreshTitledListView(Context context) {
		this(context, null);
	}
	 ...
	 *            attrs
	 */
	public PullToRefreshTitledListView(Context context, AttributeSet attrs) {
	 ...
	 *            defStyle
	 */
	public PullToRefreshTitledListView(Context context, AttributeSet attrs, int defStyle) {
	...
	protected ListView createRefreshableView(Context context, AttributeSet attrs) {
		...
		TitledListView listView = new TitledListView(context);
		mListView = listView;
	...
	public void setScrollLoadEnabled(boolean scrollLoadEnabled) {
		...
		if (scrollLoadEnabled) {
			// 设置Footer
			if (null == mLoadMoreFooterLayout) {
				mLoadMoreFooterLayout = new FooterLoadingLayout(getContext(), TipString);
			}
