...
import com.ypyg.shopmanager.bean.reqbean.MemberAddReqBean;
import com.ypyg.shopmanager.common.Constants;
import com.ypyg.shopmanager.common.DataCener;

public class MemberAddReq extends BaseQueryReq {
	private String action = "40005";
	private final MemberAddReqBean mReqBean = new MemberAddReqBean();
	private MemberInfoBean infoBean = new MemberInfoBean();

	public MemberAddReq(String smallhead, String nickname, String phone,
