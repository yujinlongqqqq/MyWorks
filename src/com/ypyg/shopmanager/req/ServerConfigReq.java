...
import com.ypyg.shopmanager.bean.ServerConfigReqBean;
import com.ypyg.shopmanager.common.Constants;
import com.ypyg.shopmanager.common.DataCener;

public class ServerConfigReq extends BaseQueryReq {
    private String action = "40005";
    private final ServerConfigReqBean mReqBean = new ServerConfigReqBean();
