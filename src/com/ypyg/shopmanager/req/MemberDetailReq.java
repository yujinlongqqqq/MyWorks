...
import com.ypyg.shopmanager.bean.reqbean.MemberDetailReqBean;
import com.ypyg.shopmanager.common.Constants;
import com.ypyg.shopmanager.common.DataCener;

public class MemberDetailReq extends BaseQueryReq {
	private String action = "40005";
	private final MemberDetailReqBean mReqBean = new MemberDetailReqBean();

	public MemberDetailReq(String id) {
		super();
		mReqBean.setId(id);
