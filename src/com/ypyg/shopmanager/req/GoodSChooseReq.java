...
import com.ypyg.shopmanager.bean.reqbean.GoodSChooseReqBean;
import com.ypyg.shopmanager.common.Constants;
import com.ypyg.shopmanager.common.DataCener;

public class GoodSChooseReq extends BaseQueryReq {
	private String action = "40005";
	private final GoodSChooseReqBean mReqBean = new GoodSChooseReqBean();

	public GoodSChooseReq(String ids) {
		super();
		mReqBean.setIds(ids);
