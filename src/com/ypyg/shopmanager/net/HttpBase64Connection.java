...
public class HttpBase64Connection implements IHttpService {
	private final static String TAG = HttpBase64Connection.class
			.getSimpleName();
	 ...
	 */
	public HttpBase64Connection(Context aContext, INetState aState,
	...
	private HttpEntity encryption(IReq aReq, HttpEntity aEntry)
		...
		try {
			reqBean.setDatamode("0");
			// BASE64加密报文
			reqBean.setData(CryptUtil.encryptBASE64(data.getBytes()));
		} catch (Exception e) {
			e.printStackTrace();
		}
