...
public class AdapterGoodOnlineList extends BaseAdapter {
	...
	public AdapterGoodOnlineList(Context context, String imageTag, List<GoodInfoBean> list) {
		mContext = context;
		mList = list;
	...
	// DataCener.getInstance().getDataService().GoodStatus(id,
	// Constants.offline, position, imageTag);
	// }
	// };
